    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-8 col-lg-offset-2 mx-auto text-center">
          <h2 className="section-heading">404 Page</h2>
          <h6>Sorry for Inconvenience</h6>
          <hr className="primary" />
          <p className="pt-contact">The page that you are looking for is not found, please browse different links or find your desire page in site map</p>
        </div>
      </div>
      <div className="row">
